...
class Talk extends React.Component {
  constructor(props) {
    ...
    this.uniqueId = this.props.talk.name + this.props.talk.event;
  ...
  render() {
    ...
    const titleClass =
      "talk-list__talk__content__name" +
      (cancelled ? " talk-list__talk__content__name--cancelled" : "");
    ...
    return (
      <div className="talk-list__talk">
        ...
        <div className="talk-list__talk__content">
          <p>
            <a href={url} className={titleClass}>
              {name}
            </a>
            {cancelledContent}
          </p>
